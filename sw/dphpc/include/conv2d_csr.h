...
void conv2d_dense_dense_dense(dense_matrix **A, dense_matrix **filter, dense_matrix *res, int channel_in, int A_col, int filter_row, int filter_col, int res_row, int res_col);